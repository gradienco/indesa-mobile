...
class _BodyState extends State<Body> {
  ...
  // void _getSurveyData(int surveyId, String namaDesa, double isos, double iek, double il, double idm){
  //   final Future<Database> dbFuture = _dbHelper.initializeDatabase();
  //   dbFuture.then((database){
  ...
  //         Survey _survey = Survey(data['user_id'], data['desa_id'], data['survey_id'], data['iks'], data['ike'], data['ikl'],data['idm'], answerObj);
  //        // Navigator.pushNamed(context, RouterGenerator.routeHistoryQuiz, arguments: _survey);
  //         Navigator.push(context, FadeRoute(page: ResultHistoryPage(_survey, namaDesa, isos, iek, il, idm)));
  //         print(_answers);
  //         print(data);
  //       });
  //     });
  ...
  void _goToResultHistoryPage(int surveyId, String namaDesa, double isos, double iek, double il, double idm){
            ...
            itemBuilder: (BuildContext context, int index){
              ...
              return Center(
                child: ListTileHistory(
                  ...
                  kategori: _getCategory(item[index]['poinIdm'].toDouble()),
                  onTap: (){
