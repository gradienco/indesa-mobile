...
class _SurveyPageState extends State<SurveyPage> {
  ...
  void _next() {
    ...
    setState(() {
      ...
      setValue(
          _questionIndex, _selectedValue, _qna.listQNA[_questionIndex]['id']);
      _questionIndex++;
  ...
  void _onPrevious() {
    if (_questionIndex == 0) {
      ...
      //   print("total skor : ${_totalScore}");
      print(
          "value soal ke - ${_questionIndex + 2} : ${answers[_questionIndex + 1].value}");
            ...
            actions: <Widget>[
              ...
              new GestureDetector(
                ...
                child: Text(
                  "IYA",
                  style: TextStyle(
                      fontWeight: FontWeight.bold, fontSize: setFontSize(47)),
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: (_questionIndex < _qna.listQNA.length)
            ? Container(
                color: cDarkGreen,
                child: ListView(
                  children: [
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(
                            top: 20, bottom: 6, left: deviceWidth() * 0.055),
                        child: Text(
                      ...
                      child: Row(
                        children: [
                          ProgressBar(
                            ...
                            progress:
                                (_questionIndex + 1) / _qna.listQNA.length,
                          ),
                          IconButton(
                            icon: Icon(
                              Icons.apps,
                            ...
                            onPressed: () {
                              Navigator.pushNamed(
                                  context, RouterGenerator.routeHistoryQuiz,
                                  arguments: answers);
                            },
                          )
                        ],
                    ...
                    Container(
                      height: deviceHeight() * 0.785,
                      margin: EdgeInsets.symmetric(
                          vertical: 10, horizontal: deviceWidth() * 0.05),
                      padding:
            ...
            : ResultPage(_totalScore, _iSos, _iEk, _iL, widget.desaID, answers),
      ),
    );
  }
}
