    ...
    return ListView(
      children: [
        Container(
          ...
          child: Text(qna.listQNA[questionIndex]['pertanyaan'],
        ...
        ...(qna.listQNA[questionIndex]['jawaban'] as List<Map<String, Object>>).map((data){
          return RadioButton((val)=>onChangeValue(val), data['text'], defaultValue, data['score']);
        }).toList(),
