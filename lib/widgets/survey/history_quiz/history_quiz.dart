      ...
      child: Column(
        children: [
          Container(
            ...
            child: Text("${questionIndex+1}. ${qna.listQNA[questionIndex]['pertanyaan']}",
              textAlign: TextAlign.justify,
              style: TextStyle(
                  color: (answers[questionIndex].value>5) ? Colors.red : cDarkGreen,
          ...
          Container(
            ...
            child: RadioListTile(
              title: Text(
                  (answers[questionIndex].value>5) ? "Belum dijawab" : answerText[_getAnswerIndex(answers[questionIndex].value)]['text']
              ),
              onChanged: (val){},
              groupValue: 1,
              value: 1,
              activeColor: (answers[questionIndex].value>5) ? Colors.red : cDarkGreen,
            ),
          ),
